...
from multi_thread import Ui_multiForm
...
class multi_thread(QWidget, Ui_multiForm):
    def __init__(self):
        super(multi_thread, self).__init__()
        self.setupUi(self)
        self.modify_flag = 0
        self.pushButton_3.clicked.connect(self.open_dialog)
        self.pushButton_4.clicked.connect(self.modify_dialog)
        #self.pushButton_5.clicked.connect(self.delete_dialog)
        self.winList=[]


    def open_dialog(self):
        dialog1 = MainForm()
        self.winList.append([dialog1])
        dialog1.show()

    def modify_dialog(self):
        self.winList[self.modify_flag][0].setWindowTitle('{}'.format(self.modify_flag))
        self.winList[self.modify_flag][0].activateWindow()
        self.modify_flag = self.modify_flag + 1
    # def delete_dialog(self):
    #     self.winList[0][0].deleteLater()
    #     self.winList = self.winList[1:]
...
class MainForm(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_2.clicked.connect(self.open_multi)
        ...
        self.read_top.triggered.connect(self.open_file)
        self.xls_top.triggered.connect(self.gengrate_current_file)
        self.xls_all_top.triggered.connect(self.gengrate_all_file)
        self.graph_top.triggered.connect(self.childShow_3)
    ...
    def get_way_2(self):
        ...
        if text3=='Deffuant' and text4 == 'squareGrid':
            ...
            self.mode=22
        if text3 == 'Deffuant' and text4 == 'small world network':
            ...
            self.lineEdit_11.setText("0.5")
            self.mode = 26
        if text3 == 'Deffuant' and text4 == 'random network':
            self.label_11.setText("probability")
            self.label_14.setText("neighbours")
            ...
            self.lineEdit_11.setText("0.5")
            self.mode = 27
        if text3=='Deffuant' and text4 == 'scale-free network':
    ...
    def childShow(self):
        ...
        if self.tabWidget.currentIndex()==0:
            ...
            if text3 == 'election' and text4 == 'squareGrid':
            ...
            elif text3=='Deffuant' and text4=='small world network':
                self.number2 = float(self.lineEdit_7.text())  # 第一行输入
                self.number1 = int(self.lineEdit_9.text())  # 第二行输入
                self.number5 = int(self.lineEdit_8.text())
                self.boyi_steps=int(self.lineEdit_12.text())
                self.number3=float(self.lineEdit_10.text())
                self.number4 = float(self.lineEdit_11.text())
                ...
                if not self.init_flag == 2:
                    self.child.widget.mpl.flag = 0
                    self.child.widget.mpl.step_time = 0
                    self.child.widget.mpl.mode = 26
                    self.child.widget.mpl.small_world_deffuant(self.number1, self.number2, self.boyi_steps, self.number5,self.number3,self.number5)
                    self.item_cluster.setText("cluster coefficient:" + str(self.child.widget.mpl.cluster))
                    self.item_path.setText("average path length:" + str(self.child.widget.mpl.path))
                    self.item_degree.setText("average degree:" + str(self.child.widget.mpl.ave_degree))
            ...
            elif text3=='Deffuant' and text4=='random network':
                self.number2 = float(self.lineEdit_7.text())  # 第一行输入
                self.number1 = int(self.lineEdit_9.text())  # 第二行输入
                self.number5 = int(self.lineEdit_8.text())
                self.boyi_steps=int(self.lineEdit_12.text())
                ...
                if not self.init_flag == 2:
                    self.child.widget.mpl.flag = 0
                    self.child.widget.mpl.step_time = 0
                    self.child.widget.mpl.mode = 27
                    self.child.widget.mpl.random_network_deffuant(self.number1, self.number2, self.boyi_steps, self.number5,self.number3,self.number5)
            ...
            elif text3=='Deffuant' and text4 == 'scale-free network':
                self.number1 = int(self.lineEdit_7.text())
                self.number2 = int(self.lineEdit_9.text())
                self.number3 = float(self.lineEdit_10.text())  # 第一行输入
                self.number4 = float(self.lineEdit_11.text())  # 第二行输入
                self.number5 = int(self.lineEdit_8.text())
                self.boyi_steps=int(self.lineEdit_12.text())
                ...
                if not self.init_flag == 2:
                    self.child.widget.mpl.flag = 0
                    self.child.widget.mpl.step_time = 0
                    self.child.widget.mpl.mode = 28
                    self.child.widget.mpl.scale_free_deffuant(self.number1,self.number2, self.number3,self.number4,self.number5,self.boyi_steps)
    ...
    def childShow_2(self):
        ...
        if self.tabWidget.currentIndex() == 2:
            if text5 == 'SIS' and text6 == 'small world network':
                self.x = list(range(len(self.child.widget.mpl.degree)))
                self.y = [i for i in self.child.widget.mpl.degree]
            ...
            if text5 == 'SI' and text6 == 'random network':
                self.x = list(range(len(self.child.widget.mpl.degree)))
                self.y = [i for i in self.child.widget.mpl.degree]
            ...
            if text5 == 'SI' and text6 == 'squareGrid':
                self.x = list(range(len(self.child.widget.mpl.degree)))
                self.y = [i for i in self.child.widget.mpl.degree]
                ...
                self.gridlayout = QGridLayout(self.widget_2)
                    # 在GUI的widget中添加布局
                self.gridlayout.addWidget(self.F)
            if text5 == 'SIR' and text6 == 'scale-free network':
                self.x = list(range(len(self.child.widget.mpl.degree)))
                self.y = [i for i in self.child.widget.mpl.degree]
